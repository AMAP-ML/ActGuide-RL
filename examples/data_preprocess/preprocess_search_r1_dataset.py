...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--hf_repo_id", default="/mnt/workspace/user/data/nq_hotpotqa_train", help="HuggingFace dataset repository ID."
    )
    parser.add_argument(
        "--local_dir",
        default="/mnt/workspace/user/data/searchR1_processed_direct",
