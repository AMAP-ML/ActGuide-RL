...
# export BASE_MODEL='/mnt/workspace/common/models/Qwen3-4B-Instruct-2507'
# export EXPERIMENT_NAME=deepresearch-1k-qwen3-4b-guidedv2-r066-turn30-n8-local

# export BASE_MODEL="${MODEL_DIR:-/path/to/models}/qwen3_4b"
# export EXPERIMENT_NAME=deepresearch-wrong-iter12-qwen3-4b-sft-v6-noadaptive-inject-turn30-n8

export BASE_MODEL="${PROJECT_DIR:-/path/to/ActGuide-RL}/verl_checkpoints/merge/deepresearch_1k_qwen3_4b_actguide_turn30_n8"
export EXPERIMENT_NAME=deepresearch-qwen3-4b-guide-meesages-test

TRAIN_FILES_LIST=(
    "${DATA_DIR:-/path/to/data/deepsearch}/GuidedRL/ASearcher-DeepResearch-turn30-sample1k-actguide.parquet"
)
TRAIN_FILES="["
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.validation_data_dir=${PROJECT_DIR}/verl_dump_local/$EXPERIMENT_NAME \
    trainer.default_local_dir=${PROJECT_DIR}/verl_checkpoints_local/$EXPERIMENT_NAME \
