...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: str | list[str] = "console", config=None):
        ...
        if "swanlab" in default_backend:
            ...
            SWANLAB_API_KEY = os.environ.get("SWANLAB_API_KEY", "${SWANLAB_API_KEY:?Set SWANLAB_API_KEY}")
            SWANLAB_LOG_DIR = os.environ.get("SWANLAB_LOG_DIR", "/mnt/workspace/user/log/swanlab_log")
